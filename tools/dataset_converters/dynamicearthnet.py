...
def convert_label(train_txt_path):
    # read file label train
    train_txt = train_txt_path #'../train.txt'
    ...
    directory = "/home/Hung_Data/HungData/mmseg_data/Datasets/DynamicEarthNet/planet"

    for data, label in tqdm(data_labels):
        destination_file_name = data[1:].replace('/', '_')

        source_file = '/home/Hung_Data/HungData/mmseg_data/Datasets/DynamicEarthNet/planet'+data
        destination_file = '../data_monthly/planet/'+destination_file_name
        if not os.path.exists(destination_file):
            history_copy.append([source_file, destination_file])
            copy_file(source_file, destination_file)

        source_file = '/home/Hung_Data/HungData/mmseg_data/Datasets/DynamicEarthNet'+label
        destination_file = directory+destination_file_name
        # if not os.path.exists(destination_file):
        history_copy.append([source_file, destination_file])
        copy_file(source_file, destination_file)
